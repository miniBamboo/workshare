...
import (
	...
	"github.com/miniBamboo/workshare/consensus/builtin/energy"
	"github.com/miniBamboo/workshare/consensus/builtin/gen"
	"github.com/miniBamboo/workshare/consensus/builtin/params"
	"github.com/miniBamboo/workshare/consensus/builtin/prototype"
...
var (
	...
	Auworkshareity = &auworkshareityContract{mustLoadContract("Auworkshareity")}
...
type (
	...
	auworkshareityContract struct{ *contract }
...
func (a *auworkshareityContract) Native(state *state.State) *auworkshareity.Auworkshareity {
	return auworkshareity.New(a.Address, state)
}
...
func FindNativeCall(to workshare.Address, input []byte) (*abi.Method, func(*xenv.Environment) []interface{}, bool) {
